...
window.TRAINING_DATA['0009'] = {
  ...
  questions: [
    ...
    { tag:"D1", q:"A security review requires that role assignments follow least privilege for every AI resource. Which control enforces this?",
      ...
      why:"Least-privilege enforcement is implemented through <b>role-based access policies</b>, a D1 security control. <a href='https://learn.microsoft.com/en-us/azure/ai-foundry/responsible-use-of-ai-overview' target='_blank' rel='noopener'>Responsible AI in Microsoft Foundry</a>." },
    ...
    { tag:"D2", q:"A workflow needs the model to reason across several intermediate steps before producing a final answer, rather than answering in one shot. What do you design?",
      ...
      why:"Multi-step reasoning before a final answer is a <b>multistep reasoning pipeline</b>, a named D2 build pattern. <a href='https://learn.microsoft.com/en-us/azure/ai-foundry/agents/overview' target='_blank' rel='noopener'>Microsoft Foundry Agent Service overview</a>." },
    ...
    { tag:"D4", q:"An app must produce a structured JSON object of {entities, topics, summary} from free-text reviews, in a shape no built-in extractor covers. What's the best fit?",
      ...
      why:"Custom/novel structured-output shapes are best served by <b>generative prompting</b>, not a fixed extractor. <a href='https://learn.microsoft.com/en-us/azure/ai-services/language-service/overview' target='_blank' rel='noopener'>Azure AI Language overview</a>." },
    ...
    { tag:"D5", q:"An extraction pipeline's structured output must be consumable directly by an agent's knowledge tool with no manual step in between. What must be configured?",
      ...
      why:"D5 explicitly calls for connecting retrieval pipelines <b>directly to workflows and agent tools</b>. <a href='https://learn.microsoft.com/en-us/azure/search/retrieval-augmented-generation-overview' target='_blank' rel='noopener'>RAG overview</a>." },
