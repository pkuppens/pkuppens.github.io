...
window.TRAINING_DATA['0002'] = {
  ...
  questions: [
    { tag:"D1",
      ...
      answer:0,
      why:"Cost/latency-sensitive, narrow-scope tasks favor a <b>small language model</b>. LLMs are for broader reasoning; multimodal models add modalities you don't need here; Foundry Tools are prebuilt capabilities, not general models. <a href='https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/foundry-models-overview' target='_blank' rel='noopener'>Foundry model catalog</a>." },
    ...
    { tag:"D1",
      ...
      answer:0,
      why:"Repeatable, automated releases come from <b>CI/CD integration</b>. The other options don't address deployment repeatability. <a href='https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/set-up-ci-cd-cli' target='_blank' rel='noopener'>Foundry CI/CD with GitHub Actions</a>." }
  ]
};
