...
window.TRAINING_DATA['0005'] = {
  ...
  questions: [
    { tag:"D4",
      ...
      answer:0,
      why:"Standard, structured text tasks at scale are the strength of the purpose-built <b>Azure Language</b> service. An LLM prompt is more flexible but unnecessary overhead here." },
    ...
    { tag:"D4",
      ...
      answer:0,
      why:"Novel, flexible output shapes are best served by <b>generative prompting</b>. Translator and speech-to-text solve different problems; a fixed extractor can't adapt." },
    ...
    { tag:"D4",
      ...
      answer:0,
      why:"Audio → text is <b>speech recognition</b>. Synthesis goes the other direction; translation crosses languages; sentiment scores tone, not transcription." },
    ...
    { tag:"D4",
      ...
      answer:0,
      why:"Text → audio output is <b>speech synthesis</b>. Recognition is the reverse direction; OCR and entity detection are unrelated to audio output." },
    ...
    { tag:"D4", type:"multi",
      ...
      answers:[0,1],
      why:"The study guide names both <b>Azure Translator</b> and an <b>LLM-powered translation flow</b> as valid paths. Recognition, indexing, and filtering don't translate text." },
    ...
    { tag:"D4",
      ...
      answer:0,
      why:"Reasoning over audio content, beyond transcription, is <b>multimodal reasoning from audio input</b>. Plain transcription only converts modality, without reasoning about meaning." },
    ...
    { tag:"D4",
      ...
      answer:0,
      why:"Continuous, two-way voice interaction is <b>speech integrated as an agent modality</b> — the study guide's specific phrasing, distinct from isolated one-off calls." },
    ...
    { tag:"D4", type:"order",
      ...
      why:"Speech-to-text feeds analysis/reasoning, which produces a text reply, which is then synthesized back to speech — in that order." }
  ]
};
