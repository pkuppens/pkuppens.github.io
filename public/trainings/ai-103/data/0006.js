...
window.TRAINING_DATA['0006'] = {
  ...
  questions: [
    { tag:"D5",
      ...
      answer:0,
      why:"Combining exact keyword matching with vector similarity is <b>hybrid search</b>. Vector-only or semantic-only each cover just one side." },
    ...
    { tag:"D5",
      ...
      answer:0,
      why:"Embedding-similarity matching is <b>vector search</b>. Keyword search needs exact/near-exact terms; OCR and field extraction are extraction steps, not search types." },
    ...
    { tag:"D5",
      ...
      answer:0,
      why:"Image-based text becomes retrievable via <b>OCR</b> during ingestion. Synthesis and generation don't extract text; safety filters don't ingest content." },
    ...
    { tag:"D5",
      ...
      answer:0,
      why:"<b>Content Understanding</b> analyzers are built to produce clean, grounded representations for agent/RAG consumption. Translator and Speech serve other modalities; an index alone doesn't extract content." },
    ...
    { tag:"D5", type:"multi",
      ...
      answers:[0,1],
      why:"Document extraction combines <b>OCR</b> and <b>layout analysis</b> (plus field extraction). Speech recognition, video segmentation, and image generation don't apply to a scanned document." },
    ...
    { tag:"D5",
      ...
      answer:0,
      why:"Extraction pipelines should connect <b>directly to workflows and agent tools</b>, avoiding manual hand-off steps." },
    ...
    { tag:"D5", type:"match",
      ...
      answer:[0,1,2],
      why:"Markdown for downstream reasoning = a <b>Content Understanding markdown analyzer</b>; verbatim values = <b>field extraction</b>; relevance ranking = <b>semantic/hybrid search</b>." }
  ]
};
