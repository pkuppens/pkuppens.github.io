  ...
  return (
    <div className={styles.periodGrid}>
      <div className={styles.field}>
        <label className={styles.fieldLabel}>Start (YYYY-MM)</label>
        <input
          type="text"
          placeholder="2026-05"
      ...
      <div className={styles.field}>
        <label className={styles.fieldLabel}>
          <input
            ...
            onChange={(e) => onChange({ ...period, endCurrent: e.target.checked, endYearMonth: e.target.checked ? null : period.endYearMonth })}
          />{' '}
          Current role
        </label>
      </div>
      {!period.endCurrent && (
        <div className={styles.field}>
          <label className={styles.fieldLabel}>End (YYYY-MM)</label>
          <input
            type="text"
            placeholder="2025-12"
      ...
      <div className={styles.field}>
        <label className={styles.fieldLabel}>Raw period text (display)</label>
        <input
          type="text"
